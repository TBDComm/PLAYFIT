...
| 2026-03-26 | fix(ui): favicon transparent — replace ImageResponse URL-fetch approach with static app/icon.png (32×32) + app/apple-icon.png (180×180 dark bg); GuildelineMark SVG → PNG Image; icon.tsx + apple-icon.tsx deleted | app/icon.png(new), app/apple-icon.png(new), icon.tsx(del), apple-icon.tsx(del), GuildelineMark.tsx |
