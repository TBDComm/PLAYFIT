...
| 2026-03-19 | UI: result page layout — inner max-width 1100px centered; thumbnail 40%/130px natural ratio (no crop); logo outside .inner at true top-left | `result/page.tsx`, `result/page.module.css` |
