...
| 2026-03-26 | fix(ui): logo PNG trimmed — excess transparent padding cropped (1080→769px), icon fills favicon; NavLogo/GuildelineMark auto-updated via shared PNG | public/guildeline-logo.png, icon.tsx, apple-icon.tsx |
