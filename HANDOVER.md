...
| 2026-03-26 | fix(ui): logo PNG trimmed → zero padding (671x587); OG images updated (opengraph-image, blog/[slug]/opengraph-image) — SVG replaced with base64 PNG mark | public/guildeline-logo.png, icon.tsx, apple-icon.tsx, opengraph-image.tsx, blog/[slug]/opengraph-image.tsx |
