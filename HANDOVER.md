...
| 2026-03-27 | feat(ui): login modal title — icon (guildeline-logo.png 22px) + accent color on 'guildeline'; overlay flex-start+padding-top:72px (modal sits higher) | Header.tsx, Header.module.css |
