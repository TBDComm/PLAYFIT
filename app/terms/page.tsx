...
export const metadata: Metadata = {
  title: '이용약관 — Guildeline',
  description: 'Guildeline 서비스 이용약관을 안내합니다.',
  ...
  return (
    <main className={styles.page}>
      ...
      <p>
        ...
        Guildeline은 Steam Web API를 통해 공개된 정보를 표시할 뿐이며, 해당 콘텐츠에 대한 소유권을
        주장하지 않습니다.
      </p>

      <h2>5. 서비스 변경 및 중단</h2>
      <p>
        Guildeline은 사전 통지 없이 서비스의 일부 또는 전체를 변경하거나 중단할 수 있습니다.
        서비스 중단으로 인한 손해에 대해 Guildeline은 책임을 지지 않습니다.
      </p>

      <h2>6. 면책 조항</h2>
      <p>
        서비스는 현재 상태(&ldquo;as-is&rdquo;)로 제공됩니다. Guildeline은 서비스의 중단 없는 운영,
